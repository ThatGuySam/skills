...
Every installation path below uses `skills/htma-measure`. The Skills CLI installs HTMA Measure alone; the marketplace bundle installs all published skills.
...
Use the plural command, `npx skills`.
